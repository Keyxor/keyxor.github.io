---
title: "Experience"
description: "Roles, certifications, training, and selected work."
hidemeta: true
ShowToc: true
TocOpen: false
...
Ten years in IT, four in security. Currently vulnerability management and
incident response on a large multi-tenant estate, with offensive work and
detection engineering on my own time.
...
Entry-level network and desktop support: cabling and switch configuration,
workstation imaging and deployment, and Tier I troubleshooting.
...
Windows Security and Sysmon event analysis: logon types, Kerberos ticket
activity, credential access, and service and scheduled-task creation.
...
- Executed multi-stage Active Directory intrusion chains in lab environments,
  ...
  delegation via machine account creation, NTLM coercion with offline
  credential recovery, and ACL abuse escalating to DCSync. Each chain is
  documented with the commands used, the artifacts produced, and the privilege
...
[About](/about/) · [GitHub](https://github.com/Keyxor) · [LinkedIn](https://www.linkedin.com/in/noah-cuberly)
